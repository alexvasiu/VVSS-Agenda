...
public class MainClass {
	...
	private static void adaugActivitate(RepositoryActivity activityRep,
		...
		try {
			...
			Activity act = new Activity(activityRep.count() + 1, start, end, user.getName(),
